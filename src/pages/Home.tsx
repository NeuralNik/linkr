import { ArrowRight, Zap, Shield, Download, Smartphone } from 'lucide-react';
        ...
        <div className="container mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center space-y-4 mb-16">
            <h2 className="text-3xl md:text-4xl font-bold">
              Why Choose Our{' '}
              <span className="text-neon-green text-glow">QR Generator</span>
            </h2>
      ...
      <section id="qr-generator" className="py-20">
        <div className="container mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center space-y-4 mb-16">
            <h2 className="text-3xl md:text-4xl font-bold">
              Generate Your{' '}
              <span className="text-neon-green text-glow">QR Code</span>
            </h2>
            <p className="text-lg text-muted-foreground max-w-2xl mx-auto">
              Enter any URL and get your QR code instantly
            </p>
          </div>
